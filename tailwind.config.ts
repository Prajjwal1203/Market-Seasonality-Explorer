	...
	theme: {
		...
		extend: {
			colors: {
				...
				bull: {
					primary: 'hsl(var(--bull-primary))',
					secondary: 'hsl(var(--bull-secondary))',
					muted: 'hsl(var(--bull-muted))'
				},
				bear: {
					primary: 'hsl(var(--bear-primary))',
					secondary: 'hsl(var(--bear-secondary))',
				...
				liquidity: {
					high: 'hsl(var(--liquidity-high))',
					medium: 'hsl(var(--liquidity-medium))',
					low: 'hsl(var(--liquidity-low))'
				},
				calendar: {
			...
			boxShadow: {
				...
				'card': '0 4px 20px hsl(220 13% 5% / 0.5)'
			}
		}
	},
